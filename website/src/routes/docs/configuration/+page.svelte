...
<h1 class="scroll-reveal" style="font-size: 2rem; font-weight: 600; letter-spacing: -0.02em; margin-bottom: 0.5rem;">Configuration</h1>
<p class="scroll-reveal" style="color: var(--text-secondary); margin-bottom: 2.5rem;">cora uses a layered config system. Later sources override earlier ones.</p>
...
<section class="docs-section scroll-reveal">
	...
	<p style="color: var(--text-secondary); margin-bottom: 1.5rem;">Settings are resolved in this order (highest priority first):</p>
...
<section class="docs-section scroll-reveal">
	...
	<p style="color: var(--text-secondary); margin-bottom: 1rem;">Create this file in your project root. Run <code class="syntax-highlight">cora init</code> to generate it.</p>
...
<span class="syntax-highlight">review:</span>
  ...
  <span class="syntax-flag">max_issues:</span> <span style="color: var(--text-primary);">20</span>             <span class="syntax-comment"># max issues to report</span>
...
<span class="syntax-highlight">ignore:</span>
  ...
  <span style="color: var(--text-secondary);">- "*.min.js"</span>
...
<section class="docs-section scroll-reveal">
	...
	<p style="color: var(--text-secondary); margin-bottom: 1rem;">Each provider has its own API key variable. cora checks these for auto-detection.</p>
	<div class="docs-terminal">
		<div class="terminal-bar">
			<span class="terminal-dot terminal-dot-red"></span>
			<span class="terminal-dot terminal-dot-yellow"></span>
